 const projects = [
  {
    id: '001',
    type: "Final Project on IronHack",
    subTitle: "Practice",
    title: 'Flexy Learn',
    github: {
    ...
    preview_img:
      '/src/assets/images/logoFlexiLearn.png',
  },

  {
    id: '002',
    type: "Project on IronHack",
    subTitle: "Practice",
    title: 'Talent Match',
    github: {
      client: 'https://github.com/jdluis/flexi-learn-client',
    ...
    techStack: ['JSX', 'TailwindCSS', 'React', 'Express', 'MongoDb', 'Mongoose', 'Ayax'],
    preview_img:
      '/src/assets/images/logoTalentMatch.png',
  },
  {
    id: '003',
    type: "Project on IronHack",
    ...
    techStack: ['JSX', 'TailwindCSS', 'React', 'Express', 'MongoDb', 'Mongoose', 'Ayax'],
    preview_img:
    '/src/assets/images/theSunRisesRed.png',  },
