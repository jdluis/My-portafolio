...
import { RiAccountCircleLine, RiAncientPavilionLine, RiHealthBookLine, RiLightbulbFlashLine, RiMenuUnfoldLine } from "react-icons/ri"
  ...
  return (
    <div hidden id="mobile-nav-container">
        <div className={isMenuOpen ?? 'hidden'}>
            <button className="btn-open" onClick={handleOpenMenu}><RiMenuUnfoldLine /></button>
        </div>

        <nav onMouseLeave={handleCloseMenu} className={isMenuOpen ? 'nav-mobile' : 'hidden nav-mobile'}>
        <button className="btn-close" onClick={handleCloseMenu}><AiOutlineClose /></button>
